...
if ($resultt->num_rows > 0) {
    ...
    $sql = "UPDATE basiccharges SET hotel='$hotel',country='$country',location='$city',breakfast='$ab[$n]',lunch='$al[$n]',dinner='$ad[$n]',extrabed='$eb[$n]', childbed='$ecb[$n]', babycot='$ebc[$n]' WHERE hotel='$hotel' && location='$city' && country='$country' && season='$season'";
