...
<textarea id='demo'  class="form-control" required name="gps" rows="1" placeholder="GPS"></textarea>
  ...
  <div class="container">
    ...
    <input type="date" class="form-control" required name='renovatedon' placeholder="Last Renovated On">
   ...
   <div class="container">
        ...
        <div class="form-group">
    <label for="exampleFormControlTextarea1">Hotel General Description</label>
