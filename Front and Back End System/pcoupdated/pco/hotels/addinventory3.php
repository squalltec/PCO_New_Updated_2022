...
$sql = "UPDATE hotelsInventorydatabase SET singledescription='$roomtypedes', singleadultoccupancy='$adults', singlechildoccupancy='$children', singleextrabedsallowed='$extrabedsallowed' WHERE hotel='$hotel' && country='$country' && city='$city' && type='$roomtype'";
