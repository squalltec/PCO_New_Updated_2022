...
if ($resulttanz->num_rows > 0) {
  ...
  while($rowwanz = $resulttanz->fetch_assoc()) {
	  ...
	  ?>
                              ...
                              <li class='notranslate'><?php echo $value;?></li>
                           ...
                           ?>   
                             ...
                             <h2 class="accordion-header" id="headingOne">
                          <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne<?php echo $nn4;?>" aria-expanded="true" aria-controls="collapseOne">
                            Airports
                          </button>
                        </h2>
                           
                                <div id="collapseOne<?php echo $nn4;?>" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#accordionExample<?php echo $nn;?>">
                          <div class="accordion-body">
