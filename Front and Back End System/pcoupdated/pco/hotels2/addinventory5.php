...
$sql = "UPDATE hotelsInventorydatabase SET cancellationpolicy='$cancellationpolicy', numberofrooms='$numberofrooms' WHERE hotel='$hotel' && country='$country' && city='$city' && type='$roomtype'";
