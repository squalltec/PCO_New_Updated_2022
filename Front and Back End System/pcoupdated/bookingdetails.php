                            ...
                            <div class="dp_room_feature">
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-left"><b><?php echo $sdate;?></b></td>
                                    </tr>
                                    <tr>
                                        <td class="text-right">Check out Date: </td>
                                        <td class="text-left"><b><?php echo $edate;?></b></td>
                                    </tr>
                                    <tr>
                                        <td class="text-right">Total Days: </td>
                                        <td class="text-left"><b><?php echo $totaldays;?></b></td>
                                    </tr>
                                    <!--<tr>
                            ...
                            <div class="col-md-4">
                                <div class="dp_room_info">
                                    ...
                                    <input class='eballowed' style='display:none;' value='<?php echo $allowedeb[$x];?>'>
                                     <ul>
                                        <li><input style='width:100px;' id='ad' onclick='checkadultoccupancy(this)' min='0'  type='number' class='adult form-control' name='adultsperroom[]' value='<?php 
                                        if($adz[$ab2]==''){
                                            echo '0';
                                        }
                                        else{
